...
void cruzar(string matriz[]){
    ...
    while(inicial!=5){ //solo se puede hacer el cambio cinco veces, de 0-4
        ...
        padre2 = matriz[final];
        hijo1 = Chijo(padre1,padre2); //generamos el hijo a partir de p1 y p2
        hijo2 = Chijo(padre2,padre1); //generamos el hijo a partir de p2 y p1
...
string Chijo(string pa1, string pa2){ //Crearhijo funciona tomando los primeros 4 caracteres de la primera cadena con los ultimos 6 c. de la 2da cadena
